        ...
        <section className="home" id="home">
            <div className="home-content">
                ...
                <div className="social-media">
                    <a href="https://github.com/JOSHUA-A69"><i className='bx bxl-github'></i></a>
                    <a href="https://www.linkedin.com/in/joshua-russel-uy-a9b024243/"><i className='bx bxl-linkedin-square'></i></a>
                </div>
